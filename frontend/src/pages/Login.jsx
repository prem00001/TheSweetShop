    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-sm p-4 sm:p-6 md:p-10 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-md mx-4 sm:mx-auto border border-white/20">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-2">Your one-stop destination for delicious treats</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-gray-600">
          ...
          <Link to="/register" className="text-purple-600 hover:text-purple-800 font-semibold underline decoration-2 underline-offset-2 transition-colors">
            Register here
          </Link>
        </p>
      </div>
